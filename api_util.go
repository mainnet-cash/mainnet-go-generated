...
*/
func (a *UtilApiService) Convert(ctx _context.Context, localVarOptionals *ConvertOpts) (ConvertResponse, *_nethttp.Response, error) {
	var (
...
// ExchangeRateOpts Optional parameters for the method 'ExchangeRate'
type ExchangeRateOpts struct {
    InlineObject optional.Interface
}

/*
ExchangeRate convert between units
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *ExchangeRateOpts - Optional Parameters:
 * @param "InlineObject" (optional.Interface of InlineObject) - 
@return InlineResponse200
*/
func (a *UtilApiService) ExchangeRate(ctx _context.Context, localVarOptionals *ExchangeRateOpts) (InlineResponse200, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodPost
		localVarPostBody     interface{}
		localVarFormFileName string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/util/exchange_rate"
	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := _neturl.Values{}
	localVarFormParams := _neturl.Values{}
