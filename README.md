...
*UtilApi* | [**ExchangeRate**](docs/UtilApi.md#exchangerate) | **Post** /util/exchange_rate | convert between units
...
*WalletApi* | [**GetHistory**](docs/WalletApi.md#gethistory) | **Post** /wallet/get_history | Get a list of transactions related to a wallet
